                ...
                source: new ol.source.XYZ({
                    ...
                    tileUrlFunction: (coordinate) => {
                        ...
                        if (this.regionMap.hasTile(tileX, tileY, worldZoom)) {
                            const url = ('https://cdn.jsdelivr.net/gh/Paperoni0/DevenSMP-Website@main/assets/images/livemap/tiles/overworld/zoom.{z}/{xd}/{yd}/tile.{x}.{y}.' + this.#options.imageFormat)
                                .replace('{z}', worldZoom)
